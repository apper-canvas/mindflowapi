...
let session;
      ...
      if (hasAnxiety || avgMood < 4) {
        session = {
          ...
          duration: 5,
          activities: ['inhale for 4 counts', 'hold for 7 counts', 'exhale for 8 counts', 'positive affirmations'],
...
icon: 'Heart'
        ...
        session = {
          ...
          duration: 7,
          activities: ['inhale for 3 counts', 'exhale for 2 counts', 'breath retention for energy', 'intention setting'],
